...
const rgblight_segment_t PROGMEM layer5_rgb[]  = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_TEAL});
...
const rgblight_segment_t PROGMEM layer8_rgb[]  = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_ORANGE});
