...
const rgblight_segment_t PROGMEM layer7_rgb[]  = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_GOLD});
const rgblight_segment_t PROGMEM layer8_rgb[] = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_AZURE});
