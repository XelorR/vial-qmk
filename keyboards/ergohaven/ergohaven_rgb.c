...
const rgblight_segment_t PROGMEM layer5_rgb[]  = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_YELLOW});
const rgblight_segment_t PROGMEM layer6_rgb[]  = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_SPRINGGREEN});
const rgblight_segment_t PROGMEM layer7_rgb[]  = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_AZURE});
const rgblight_segment_t PROGMEM layer8_rgb[] = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_GOLD});
const rgblight_segment_t PROGMEM layer9_rgb[]  = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_TEAL});
const rgblight_segment_t PROGMEM layer10_rgb[]  = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_ORANGE});
...
const rgblight_segment_t PROGMEM layer13_rgb[] = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_GOLDENROD});
