...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_EN] = LAYOUT(
        ...
        LG_COLON, BU_Z, KC_X,  KC_C,  KC_D,   KC_V,                                          KC_K,   KC_H,   KC_COMM, KC_DOT, BU_PIPE, LG_SLASH,
    ...
    [_NAV] = LAYOUT(
        ...
        _______, SW_TAB,  SW_WIN,  TAB_L,   TAB_R,   C(KC_F4),                                       A(KC_F4), KC_HOME, KC_UP,   KC_END,  KC_PGUP,  _______,
        KC_RGUI, OS_CMD,  OS_ALT,  OS_CTRL, OS_SHFT, LG_WORD,                                        CW_TOGG,  KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,  KC_ALGR,
        _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______,                                        _______,  KC_PSCR, KC_APP,  LA_MAC,  DF(_GAM), _______,
    ...
    [_NUM] = LAYOUT(
        ...
        _______, KC_0,      KC_1,    KC_2,    KC_3,    KC_EQL,                                            _______, C(KC_V), C(KC_C), C(KC_X), C(KC_Z), _______,
                            LG_LT,   LG_GT,   LG_DOT,  KC_0,    KC_MINS, _______,       _______, _______, _______, _______, _______, _______
    ),
