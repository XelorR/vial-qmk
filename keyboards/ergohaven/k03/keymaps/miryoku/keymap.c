...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_EN] = LAYOUT(
       ...
       KC_NO,    BU_Z,  KC_X,  KC_C,  KC_D,   KC_V,                                          KC_K,   KC_H,  LG_AT, LG_LCBR, LG_RCBR, KC_NO,
    ...
    [_RU] = LAYOUT(
        ...
        KC_NO,   BU_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                            KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_QUOT, KC_NO,
    ...
    [_GAM] = LAYOUT(
        ...
        KC_NO, KC_LCTL, KC_Z,  KC_X,  KC_C,    KC_V,                                       _______, _______, _______, _______, KC_RCTL, KC_NO,
                        KC_NO, KC_NO, KC_LALT, KC_SPC, LA_GFN, KC_NO,      KC_NO, DF(_EN), KC_PSCR, KC_ENT,  KC_NO,   KC_NO
    ),
    ...
    [_NUM] = LAYOUT(
        ...
        _______, KC_0,      KC_1,    KC_2,    KC_3,    KC_EQL,                                            _______, C(KC_V), C(KC_C), C(KC_X), C(KC_Z), _______,
                            KC_NO,   KC_NO,   LG_DOT,  KC_0,    KC_MINS, _______,       _______, _______, _______, _______, KC_NO,   KC_NO
    ),
    ...
    //                        LG_LCBR,  LG_RCBR,  LG_COMMA, _______, S(KC_MINS), MC_26,    MC_25, _______, _______, _______, _______, _______
    // ),
    ...
    [_SYM] = LAYOUT(
        ...
        KC_NO,   LG_HASH, KC_ASTR, LG_COLON, LG_SLASH, LG_DLR,                                              LG_PERC, LG_PIPE,  LG_TILD, LG_AMPR, LG_QUES, KC_NO,
                          KC_NO,   KC_NO,    KC_LCTL,  KC_SPC,  _______, KC_NO,           KC_NO,   _______, _______, _______,  KC_NO,   KC_NO
    ),

    [_FN] = LAYOUT(
        _______, _______, _______, _______, _______, _______,                                       _______, _______, _______, _______, _______, _______,
        _______, KC_F12,  KC_F7,   KC_F8,   KC_F9,   KC_PSCR,                                       DM_REC1, _______, _______, _______, _______, KC_NO,
        _______, KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_SCRL,                                       DM_RSTP, OS_SHFT, OS_CTRL, OS_ALT,  OS_CMD,  KC_NO,
        _______, KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_PAUS,                                       DM_PLY1, C(KC_V), C(KC_C), C(KC_X), C(KC_Z), KC_NO,
                          _______, _______, _______, _______, _______, _______,   _______, _______, _______, _______, _______, _______
    ),
    ...
    [_MACRO] = LAYOUT(
        ...
        KC_NO, MC_20, MC_22, MC_22, MC_23,   MC_24,                                           MC_25,   MC_26,   MC_27, MC_28, MC_29, KC_NO,
                      KC_NO, KC_NO, _______, _______, _______, KC_NO,         KC_NO, _______, _______, _______, KC_NO, KC_NO
    ),

    [_MEDIA] = LAYOUT(
        KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                                           KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
        KC_NO,  _______, _______, _______, _______, KC_VOLU,                                         _______, _______, KC_VOLU, _______, _______, KC_NO,
        KC_NO,  OS_CMD,  OS_ALT,  OS_CTRL, OS_SHFT, KC_VOLD,                                         _______, KC_MPRV, KC_VOLD, KC_MNXT, _______, KC_NO,
        KC_NO,  C(KC_Z), C(KC_X), C(KC_C), C(KC_V), KC_MUTE,                                         _______, _______, KC_MUTE, _______, _______, KC_NO,
