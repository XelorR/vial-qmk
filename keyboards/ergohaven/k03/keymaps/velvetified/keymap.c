...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [_ENG] = LAYOUT( \
          ...
          OSM(MOD_LSFT), MO_Z,   KC_X,    KC_C,    KC_D,   KC_V,                                  KC_K,   KC_H,          KC_COMM, KC_DOT, KC_SLSH, OSM(MOD_LSFT), \
                         KC_LGUI, KC_LALT, KC_LCTL, LA_NAV, KC_SPC, KC_MUTE,      KC_HOME, KC_ENT, LA_SYM, OSM(MOD_RCTL), KC_LBRC, KC_RBRC \
        ),

        [_RUS] = LAYOUT(
            _______, _______, _______, _______, _______, _______,                                         _______, _______, _______, _______, _______, _______,
            _______, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                                            KC_Y,    KC_U,    KC_I,    KC_P,    KC_LBRC, _______,
            _______, AL_A,    KC_S,    KC_D,    KC_F,    KC_G,                                            KC_H,    KC_J,    KC_K,    KC_L,    AL_SCLN, KC_QUOT,
        ...
        [_GAM] = LAYOUT(
            ...
            KC_M,    KC_LCTL, KC_Z,  KC_X,  KC_C,  KC_V,                                                 _______, _______, _______, _______, KC_RCTL, _______,
                              _______, _______, _______, LA_GFN, KC_SPC, _______,     _______, KC_PSCR, DF(_ENG), _______, _______, _______
        ),
        ...
        [_GFN] = LAYOUT(
            ...
            _______, KC_G,  KC_J,  KC_I,  KC_M,  KC_T,                                                DM_PLY2, _______, _______, _______, _______, _______,
                            _______, _______, _______, _______, KC_ENT, _______,     _______, _______, LA_MED, _______, _______, _______
        ),

        [_NAV] = LAYOUT( \
         KC_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,    KC_F5,                                            KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F12,
         SW_WIN,  CL_WIN,  KC_HOME, KC_UP,   KC_END,   KC_ESC,                                           KC_PGUP, KC_7,    KC_8,    KC_9,   KC_EQL,  LG_SLASH,
         KC_DEL,  _______, KC_LEFT, KC_DOWN, KC_RIGHT, KC_ENT,                                           KC_PGDN, KC_4,    KC_5,    KC_6,   KC_PLUS, KC_ASTR,
         _______, _______, PREVWRD, CW_TOGG, NEXTWRD,  KC_TAB,                                           KC_PSCR, KC_1,    KC_2,    KC_3,   KC_MINS, _______,
      ...
      [_MED] = LAYOUT(
       ...
       DF(_GAM), _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,                                              _______, KC_VOLD, KC_MUTE, KC_VOLU, DM_PLY2, DM_REC2,
        ...
        [_ALT] = LAYOUT(
          ...
          _______, KC_NO,   KC_NO,    S(KC_8),  LG_HASH, KC_NO,                                    KC_NO, KC_NO,    S(KC_1), KC_NO,   KC_NO, _______, 
                            KC_NO,    KC_NO,    _______, KC_NO, KC_NO, KC_NO,        KC_NO, KC_NO, KC_NO, _______,  KC_NO,   KC_NO
        ),
