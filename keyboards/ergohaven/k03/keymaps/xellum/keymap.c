...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAM] = LAYOUT(
        ...
        KC_CAPS, KC_LSFT, KC_A,    KC_S,     KC_D,    KC_F,                                            _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_RSFT, KC_PSCR,
        KC_M,    KC_LCTL, KC_Z,    KC_X,     KC_C,    KC_V,                                            _______, _______, _______, _______, KC_RCTL, _______,
                          _______, _______,  KC_LALT, KC_SPC,  LA_GFN, _______,     _______, DF(_ENG), KC_SPC,  _______, _______, _______
    ),
    ...
    [_GFN] = LAYOUT(
        ...
        DM_PLY1, KC_G,    KC_J,    KC_O,    KC_P,    KC_T,                                            _______,  _______, _______, _______, _______, DM_PLY2,
