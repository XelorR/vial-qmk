...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MACRO] = LAYOUT(
        _______, _______, _______, _______, _______, _______,                                         _______, _______, _______, _______, _______, _______,
        _______, MC_20,   MC_22,   MC_22,   MC_23,   MC_24,                                           _______, MC_25,   MC_26,   MC_27,   MC_28,   MC_29,
        _______, MC_10,   MC_11,   MC_12,   MC_13,   MC_14,                                           _______, MC_15,   MC_16,   MC_17,   MC_18,   MC_19,
        _______, _______, _______, _______, _______, _______,                                         _______, _______, _______, _______, _______, _______,
                          _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______
    ),
