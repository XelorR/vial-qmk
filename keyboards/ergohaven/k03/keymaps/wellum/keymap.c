...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAM] = LAYOUT(
        ...
        _______, KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,                                            KC_NONE,  KC_NONE, KC_NONE, KC_NONE,  KC_RCTL, _______,
    ...
    [_GFN] = LAYOUT(
        ...
        _______, KC_G,    KC_J,    KC_I,    KC_M,    KC_T,                                            KC_NONE,  KC_NONE, KC_NONE, KC_NONE,  KC_RCTL, _______,
